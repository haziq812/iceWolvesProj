    ...
    <div id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar  h-100 sidebar collapse " >
        <div class="position-sticky pt-3">
            ...
            @auth
                ...
                @foreach($menuItems as $item)
                    @if($item->is_active)
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{  url($item->url) }}">
